...
import { Code, Database, Wrench, BookOpen, Brain } from 'lucide-react';
                ...
                <div className="flex flex-wrap justify-center gap-2">
                  {personalInfo.roles.slice(0, 3).map((role) => (
                    <Badge
                      key={role}
                      variant="secondary"
                      className="bg-white/80 dark:bg-gray-700/80 text-gray-700 dark:text-gray-300 hover:bg-blue-50 dark:hover:bg-blue-900/50 transition-colors duration-200"
                    >
                      {role}
                    </Badge>
                  ))}
